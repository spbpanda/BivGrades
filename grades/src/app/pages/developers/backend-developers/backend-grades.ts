...
export const BACKEND_GRADES: Grade[] = [
  {
    name: 'Intern',
    description:
      'Студент желающий в будущем стать разработчиком, интересуется бэкенд разработкой.',
    education: {
      formal: 'Студент',
      self: 'Изучение литературы ООП, JAVA',
    },
    experience: {
      total: 'Нет опыта',
      project: 'Нет опыта',
      difficulty: 'Только учебные задачи',
      teamSize: 'Индивидуальная работа с наставником',
    },
    characteristics: [],
    hardSkills: new Map([
      ['Принципы разработки ПО', ['Базовое понимание SOLID']],
      ['Язык программирования', ['Изучает  Java']],
    ]),
    softSkills: new Map([
      ['Проактивность', ['Выполняет задания наставника']],
      ['Самоорганизация', ['Под присмотром наставника']],
      ['Обучаемость', ['Усваивает большой объем информации. Требуется много времени уделять учебе.']],
    ]),
